...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { content: @map.content, lat: @map.lat, lng: @map.lng, title: @map.title } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { content: @map.content, lat: @map.lat, lng: @map.lng, title: @map.title } }
